...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    Button loginButton,registerLoginButton,newPassButton;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        registerLoginButton = (Button) findViewById(R.id.RegisterBT);
        signInButton = (SignInButton) findViewById(R.id.GSigninBT);
        newPassButton = (Button) findViewById(R.id.ForgotPwBT);
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(email)){
                    Toast.makeText(getApplicationContext(),"Udfyld venligt email",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(password)){
                    Toast.makeText(getApplicationContext(),"Indtast venligst password",Toast.LENGTH_SHORT).show();
                }

                if(password.length()<6){
                    Toast.makeText(getApplicationContext(),"Password skal være mindst 6 tegn",Toast.LENGTH_SHORT).show();
                }
                Toast.makeText(getApplicationContext(),"Logger på ....",Toast.LENGTH_SHORT).show();
        ...
        registerLoginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(),"Registrerer og logger på ....",Toast.LENGTH_SHORT).show();
        ...
        newPassButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),RegisterPWForgot.class));
            }
        });
